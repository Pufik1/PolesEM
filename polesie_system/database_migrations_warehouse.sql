...
('MAT-CI-L4-001', 'Чугун литейный передельный', 1, 'ГОСТ 4832-95', 'Л4 (C: 3.8-4.4%, Si: 1.2-2.0%, Mn: 0.5-0.9%)', 'Выплавка корпусов, щитов, колосниковых решеток, дождеприемников, люков', 'т', 1000, 0, 0, 0, 0, NULL, NULL, NULL, 'Открытая площадка под навесом, защита от прямого попадания влаги, укладка на деревянные прокладки', NULL, 10, 50, 45000, 'explicit_in_catalog'),
('MAT-CI-L5-002', 'Чугун литейный передельный', 1, 'ГОСТ 4832-95', 'Л5 (C: 3.6-4.2%, Si: 1.0-1.8%, Mn: 0.6-1.0%)', 'Литье изделий с повышенными требованиями к обрабатываемости и прочности', 'т', 1000, 0, 0, 0, 0, NULL, NULL, NULL, 'Открытая площадка под навесом, защита от влаги, укладка на деревянные прокладки', NULL, 10, 30, 47000, 'explicit_in_catalog'),
('MAT-CI-GREY-003', 'Чугун серый литейный', 1, 'ГОСТ 1412-85', 'СЧ15, СЧ20, СЧ25', 'Корпуса электродвигателей, подшипниковые щиты, фланцы, решетки', 'т', 1000, 0, 0, 0, 0, NULL, NULL, NULL, 'Сухое складское помещение, влажность ≤70%, защита от коррозии', NULL, 15, 40, 52000, 'standard_industry_bom'),
('MAT-AL-AB87-004', 'Алюминий вторичный в чушках', 1, 'ГОСТ 295-98', 'АВ87', 'Литье беличьих клеток роторов, производство ферросплавов, раскисление стали', 'т', 1000, 0, 0, 0, 0, NULL, NULL, NULL, 'Сухое помещение, защита от влаги и окисления, складирование на поддонах', NULL, 5, 20, 38000, 'explicit_in_catalog'),
('MAT-AL-AB87F-005', 'Алюминий вторичный гранулированный', 1, 'ГОСТ 295-98', 'АВ87Ф (фракция 5-30 мм)', 'Алюминотермические процессы, легирование, литье под давлением', 'т', 1000, 0, 0, 0, 0, NULL, NULL, NULL, 'Герметичная тара или биг-бэги, влажность ≤60%, отдельно от окислителей', NULL, 5, 15, 40000, 'explicit_in_catalog'),
